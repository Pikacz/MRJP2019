...
void TestUnit::createLatteLib() noexcept {
    ...
    headerFile << "char * concatStrings(char * s1, char * s2);" << endl;
    ...
    headerFile << "void * wrapDestructable(void * ptr, bool isString);" << endl;
    headerFile << "void * wrapUndestructable(void * ptr, bool isString);" << endl;
    ...
    codeFile << "}" << endl;
    codeFile << endl;
    codeFile << "char * concatStrings(char * s1, char * s2) {" << endl;
    ...
    codeFile << "};" << endl;
    codeFile << endl;
    codeFile << "void * wrapDestructable(void * ptr, bool isString) {" << endl;
    codeFile << "    LattePointer * obj = new LattePointer();" << endl;
    codeFile << "    obj->counter = 0;" << endl;
    codeFile << "    obj->desctructable = true;" << endl;
    codeFile << "    obj->isString = isString;" << endl;
    codeFile << "    obj->value = ptr;" << endl;
    codeFile << "    return obj;" << endl;
    codeFile << "}" << endl;
    codeFile << endl;
    codeFile << "void * wrapUndestructable(void * ptr, bool isString) {" << endl;
    codeFile << "    LattePointer * obj = new LattePointer();" << endl;
    codeFile << "    obj->counter = 0;" << endl;
