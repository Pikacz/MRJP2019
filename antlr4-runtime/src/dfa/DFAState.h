...
namespace dfa {
  ...
  public:
    ...
    ///  <seealso cref="Token#EOF"/> maps to { edges[0]}.
    ...
    /// This is set to <seealso cref="ATN#INVALID_ALT_NUMBER"/> when <seealso cref="#predicates"/>{ !=null} or
    ...
    ///  <seealso cref="#requiresFullContext"/> is { false} since full context prediction evaluates predicates
