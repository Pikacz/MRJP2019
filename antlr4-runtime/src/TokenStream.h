...
namespace antlr4 {
  ...
  public:
    ...
    /// <summary>
    /// Gets the <seealso cref="Token"/> at the specified { index} in the stream. When
    /// the preconditions of this method are met, the return value is non-null.
    /// <p/>
    /// The preconditions for this method are the same as the preconditions of
    /// <seealso cref="IntStream#seek"/>. If the behavior of { seek(index)} is
    ...
    /// stream.
    /// </returns>
    /// <exception cref="NullPointerException"> if { interval} is { null} </exception>
    ...
    /// text for. </param>
    /// <returns> The text of all tokens within the source interval of { ctx}. </returns>
