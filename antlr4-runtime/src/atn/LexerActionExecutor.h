...
namespace atn {
  ...
  public:
    ...
    /// <seealso cref="LexerATNConfig"/>. If this is { null}, the method behaves as
    ...
    /// of { lexerActionExecutor} and { lexerAction}. </returns>
    ...
    /// <seealso cref="LexerAction#isPositionDependent"/> returns { true}, it calls
    ...
    /// position-dependent lexer actions, the method returns { this}.</para>
    /// </summary>
    ...
    /// { input} <seealso cref="CharStream"/> prior to calling
    ...
    /// <seealso cref="IntStream#seek"/> to set the { input} position to the beginning
    /// of the token. </param>
