...
namespace atn {
  ...
  public:
    ...
    /// <seealso cref="RuleStopState"/>, otherwise { false} </returns>
    ...
    /// <returns> { true} if every <seealso cref="BitSet"/> in { altsets}
    /// has
    /// <seealso cref="BitSet#cardinality cardinality"/> &gt; 1, otherwise {
    /// false} </returns>
    ...
    /// </summary>
    /// <param name="altsets"> a collection of alternative subsets </param>
    /// <returns> { true} if { altsets} contains a <seealso
    /// cref="BitSet"/> with
    /// <seealso cref="BitSet#cardinality cardinality"/> 1, otherwise { false}
    /// </returns>
    ...
    /// others, otherwise { false} </returns>
    ...
    /// </summary>
    /// <param name="altsets"> a collection of alternative subsets </param>
    /// <returns> the set of represented alternatives in { altsets} </returns>
