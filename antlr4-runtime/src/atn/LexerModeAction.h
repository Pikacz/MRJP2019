...
namespace atn {
  ...
  /// <summary>
  /// Implements the { mode} lexer action by calling <seealso cref="Lexer#mode"/> with
  /// the assigned mode.
  ///
  /// @author Sam Harwell
  /// @since 4.2
  ...
  public:
    /// <summary>
    /// Constructs a new { mode} action with the specified mode value. </summary>
    ...
    /// </summary>
    /// <returns> The lexer mode for this { mode} command. </returns>
    int getMode();
    ...
    /// <summary>
    /// {@inheritDoc} </summary>
    /// <returns> This method returns { false}. </returns>
