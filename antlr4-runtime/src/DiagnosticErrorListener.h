...
namespace antlr4 {
  ...
  public:
    ...
    /// </summary>
    /// <param name="exactOnly"> { true} to report only exact ambiguities, otherwise
    /// { false} to report all ambiguities. </param>
  ...
  protected:
    ...
    /// returns the set of alternatives represented in { configs}. </returns>
