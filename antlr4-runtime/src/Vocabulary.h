...
namespace dfa {
  ...
  public:
    ...
    /// </summary>
    /// <param name="literalNames"> The literal names assigned to tokens, or { null}
    ...
    /// if no literal names are assigned. </param>
    /// <param name="symbolicNames"> The symbolic names assigned to tokens, or
    /// { null} if no symbolic names are assigned. </param>
    /// <param name="displayNames"> The display names assigned to tokens, or { null}
    ...
    ///
    /// <para>The resulting vocabulary instance returns { null} for
    /// <seealso cref="#getLiteralName(int)"/> and <seealso cref="#getSymbolicName(int)"/>, and the
    /// value from { tokenNames} for the display names.</para>
    /// </summary>
    /// <param name="tokenNames"> The token names, or { null} if no token names are
    /// available. </param>
    /// <returns> A <seealso cref="Vocabulary"/> instance which uses { tokenNames} for
    ...
    /// { null} if no string literal is associated with the type. </returns>
    ...
    /// { null} if no symbolic name is associated with the type. </returns>
