...
namespace pattern {
  ...
  /// rule; e.g., { <expr>}. These tokens are created for <seealso cref="TagChunk"/>
  ...
  public:
    ...
    /// </param>
    /// <exception cref="IllegalArgumentException"> if { ruleName} is { null}
    /// or empty. </exception>
    ...
    /// <param name="label"> The label associated with the rule tag, or { null} if
    ...
    /// { null} if this is an unlabeled rule tag. </returns>
    ...
    /// The implementation for <seealso cref="RuleTagToken"/> always returns { null}.
    virtual TokenSource *getTokenSource() const override;

    /// The implementation for <seealso cref="RuleTagToken"/> always returns { null}.
    virtual CharStream *getInputStream() const override;

    /// The implementation for <seealso cref="RuleTagToken"/> returns a string of the form { ruleName:bypassTokenType}.
