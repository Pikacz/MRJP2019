...
namespace pattern {
  ...
  public:
    ...
    /// </param>
    /// <exception cref="IllegalArgumentException"> if { tree} is { null} </exception>
    /// <exception cref="IllegalArgumentException"> if { pattern} is { null} </exception>
    /// <exception cref="IllegalArgumentException"> if { labels} is { null} </exception>
    ...
    /// label, or { null} if no parse tree matched a tag with the label. </returns>
    ...
    ///
    /// <ul>
    /// <li>Parse tree nodes matching tags of the form { <foo:anyRuleName>} and
    /// { <foo:AnyTokenName>}.</li>
    /// <li>Parse tree nodes matching tags of the form { <anyLabel:foo>}.</li>
    /// <li>Parse tree nodes matching tags of the form { <foo>}.</li>
    /// </ul>
    /// </summary>
